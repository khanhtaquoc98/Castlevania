...
void CSimon::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
	...
	else
	{
		...
		for (UINT i = 0; i < coEventsResult.size(); i++)
		{
			...
			if (dynamic_cast<CTorch*>(e->obj) || dynamic_cast<CCandle*>(e->obj) || dynamic_cast<CStairBottom*>(e->obj) || dynamic_cast<CStairTop*>(e->obj) || dynamic_cast<CBrick4Leopard*>(e->obj))
			{
				if (e->nx != 0) x += dx;
				if (e->ny != 0) y += dy;
			}
